...
public class MainFrame extends JFrame {
    ...
    private void init() {
        SwingUtilities.invokeAndWait(() -> {
            ...
            sel.addActionListener(e -> controller.setIaProcessingAlgorithm((ObjectRecognizer) ((JComboBox<?>) (e.getSource())).getSelectedItem()));
            ...
            var i = 0;
            for (var d : detecteds) {
                eastPane.add(wrap(new JLabel("Detected #" + ++i), d));
            }
